...
class RecyclerActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // es necesario utilizar layout manager
        // layout manager es una clase que define como se van a
        // desplegar los items en el recyclerview
        ...
        val jsonTest2 = "{'nombre' : 'Pedro', 'calificaciones' : [80, 70, 65, 90]}"
        val jsonTest3 = "[{'nombre' : 'Juan', 'edad' : 20}, {'nombre' : 'Pedro', 'edad' : 19}, {'nombre' : 'Santiago', 'edad' : 16}]"

        // parsing - interpretacion de texto con resultado en objeto de kotlin
        ...
        try {
            ...
            for(i in 0 until objeto3.length()) {
                ...
                Log.wtf("JSON", actual.getString("edad").toString())
            }
