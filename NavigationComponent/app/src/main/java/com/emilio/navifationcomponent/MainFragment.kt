...
class MainFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.findViewById<Button>(R.id.btnArgs).setOnClickListener{
            ...
            val action = MainFragmentDirections.actionMainFragmentToArgsFragmen(
